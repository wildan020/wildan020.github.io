...
if(empty($foto)){ // Jika user tidak memilih file foto pada form
  ...
  $sql = $pdo->prepare("UPDATE ilkomjuhdi SET nis=:nis, nama=:nama, jenis_kelamin=:jk, telp=:telp, alamat=:alamat, tanggal_lahir=:tgl, tempat_lahir=:tmt WHERE id=:id");
  ...
  if($sql){ // Cek jika proses simpan ke database sukses atau tidak
    ...
    echo "<br><a href='form_ubah_guru.php'>Kembali Ke Form</a>";
  }
  ...
  if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
    ...
    // Proses ubah data ke Database
    $sql = $pdo->prepare("UPDATE ilkomjuhdi SET nis=:nis, nama=:nama, jenis_kelamin=:jk, telp=:telp, alamat=:alamat, tanggal_lahir=:tgl, tempat_lahir=:tmt, foto=:foto WHERE id=:id");
    $sql->bindParam(':nis', $nis);
    $sql->bindParam(':nama', $nama);
    $sql->bindParam(':jk', $jenis_kelamin);
    $sql->bindParam(':telp', $telp);
