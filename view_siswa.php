...
<td class="align-middle"><?php echo "<td><a href='form_ubah.php?id=".$data['id']."'>Ubah</a</td>"?>;
<td class="align-middle"><?php echo "<td><a href='proses_hapus.php?id=".$data['id']."'>Hapus</a</td>"?>;
</tr>
<?php
